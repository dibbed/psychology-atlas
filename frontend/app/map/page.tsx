  ...
  return (
    <main className="shell page stack graph-page">
      <header className="graph-page-head">
        <div>
          <div className="meta">Knowledge Graph · Cross-domain Explorer</div>
          ...
          <p>
            {dsmScope
              ...
              : "هر گره و edge از داده ساختاریافته اطلس می‌آید. Psychologist، Theory و Timeline نیز فقط از relationهای صریح و provenance-aware وارد Graph شده‌اند؛ Degree فقط تعداد اتصال واقعی است و similarity score ساختگی وجود ندارد."}
          </p>
        ...
        <div className="graph-page-note">
          ...
          <span>{dsmScope ? "گره MASTER با ساختار و روابط منبع" : "گره در هشت لایه Concept، Disorder، Symptom، Therapy، Technique، Psychologist، Theory و Timeline"}</span>
        </div>
      </header>
      {dsmScope ? (
