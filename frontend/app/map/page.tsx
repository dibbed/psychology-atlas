    ...
    <main className="shell page stack graph-page">
      <header className="graph-page-head">
        <div>
          ...
          <p>
            {dsmScope
              ...
              : "هر گره و edge از داده ساختاریافته اطلس می‌آید. Therapy و Technique هم به‌عنوان node مستقل وارد graph شده‌اند؛ Degree فقط تعداد اتصال واقعی است و similarity score ساختگی وجود ندارد."}
          </p>
        ...
        <div className="graph-page-note">
          ...
          <span>{dsmScope ? "گره MASTER با ساختار و روابط منبع" : "گره در پنج لایه Concept، Disorder، Symptom، Therapy و Technique"}</span>
        </div>
      </header>
      {dsmScope ? (
