...
urlpatterns = [
    ...
    path("study/plans/<int:plan_id>/", views.study_plan_detail),
    path("study/plans/<int:plan_id>/availability/", views.study_plan_availability),
    path("study/plans/<int:plan_id>/scopes/", views.study_plan_scopes),
    path("study/plans/<int:plan_id>/archive/", views.study_plan_archive),
    path("study/plans/<int:plan_id>/pause/", views.study_plan_pause),
    path("study/plans/<int:plan_id>/activate/", views.study_plan_activate),
